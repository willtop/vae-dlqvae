...
class LatentQuantizer(Module):
    def __init__(
        ...
        # additional line of code that fixes a potential bug of the original repo
    ...
    def quantize(self, z: Tensor) -> Tensor:
        ...
        # here essentially it achieves the straight-through gradient estimator
    ...
    def indices_to_codes(self, indices: Tensor, project_out=True) -> Tensor:
        ...
        # scatter the indices into grids
    ...
    def forward(self, z: Tensor) -> Tensor:
        ...
        # for the number of codebooks beibg 1.
        # here is compressing that 1
        # if not self.keep_num_codebooks_dim:
        #     indices = rearrange(indices, "... 1 -> ...")

        # now simply remove the codebook dimension 1
